...
if (class_exists('Karla_Sniffs_Commenting_FileCommentSniff', true) === false) {
	$error = 'Class Karla_Sniffs_Commenting_FileCommentSniff not found';
	throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Karla_Sniffs_Commenting_ClassCommentSniff extends Karla_Sniffs_Commenting_FileCommentSniff {
