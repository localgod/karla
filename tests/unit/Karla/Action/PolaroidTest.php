...
class PolaroidTest extends PHPUnit\Framework\TestCase
{
    ...
    public function polaroid()
    {
        $actual = Karla::perform(PATH_TO_IMAGEMAGICK)->convert()
            ...
            ->getCommand();
        $expected = TestHelper::buildExpectedCommand(PATH_TO_IMAGEMAGICK, 'convert', '-polaroid 0 '.escapeshellarg($this->testDataPath.'/demo.jpg').' '.escapeshellarg('./test-200x200.png'));
