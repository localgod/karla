...
class DensityTest extends PHPUnit\Framework\TestCase
{
    ...
    public function densityAsAnInputputArgument()
    {
    	...
    	->out('test-1920x1200.png')
    	->getCommand();
    	$expected = TestHelper::buildExpectedCommand(PATH_TO_IMAGEMAGICK, 'convert', '-density 72x72 '.escapeshellarg($this->testDataPath.'/demo.jpg').' '.escapeshellarg('./test-1920x1200.png'));
    	$this->assertEquals($expected, $actual);
    }
